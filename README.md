...
- Supabase `sensor_events` remains an approved isolated manual operational log, but it has no frontend/firmware consumer. Its three remaining rows are proven Phase 5B sample-validation fixtures; deletion and removal of obsolete API-role grants are proposed but unexecuted.
