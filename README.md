...
- Phase 8B remains CURRENT and its overall endpoint cleanup remains IN PROGRESS. Phase 8B.4 Gen2 `/status` Nested Diagnostics Contract Cleanup is COMPLETE / LIVE DEVICE, CLOUD, AND HOSTED-DIAGNOSTICS VALIDATED; Phase 8B.5 Gen2 Endpoint Integration and Closeout is CURRENT / NEXT.
