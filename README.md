...
- Supabase `sensor_events` remains an approved isolated manual operational log with no frontend/firmware consumer. Its three Phase 5B sample-validation fixtures were deleted in Phase 8F.10; the table remains present and empty, and removal of obsolete API-role grants remains proposed but unexecuted.
