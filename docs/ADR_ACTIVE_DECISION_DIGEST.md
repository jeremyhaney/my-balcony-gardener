...
Phase 8C.5 is reserved for environmental presentation: 8C.5A designs condition ranges, terminology, and measurement-specific color systems; 8C.5B implements the approved descriptions and card colors. Feels Like, Dew Point, customer adoption, deterministic Demo, Gen1 review, major UI modernization, and watering-event/threshold work remain separate prioritization candidates after 8C.5B closeout, not implicit parts of 8C.5.
