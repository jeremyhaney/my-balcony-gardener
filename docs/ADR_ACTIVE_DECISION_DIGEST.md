...
Phase 8C.5A is the approved environmental-presentation design. It defines exact condition ranges, measurement-specific terminology and color meaning, neutral/unavailable behavior, Support/customer separation, WCAG AA acceptance, and deterministic Phase 8C.5B cases. Last Good and Last Reliable evidence retains condition wording and color through the existing inclusive 50-minute Phase 8C.3 boundary; older evidence is neutral and pill escalation remains unchanged. Phase 8C.5B is the separately approved implementation slice. Feels Like, Dew Point, customer adoption, deterministic Demo, Gen1 review, major UI modernization, and watering-event/threshold work remain separate prioritization candidates after 8C.5B closeout.
