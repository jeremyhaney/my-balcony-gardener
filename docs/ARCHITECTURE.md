...
- Phase 8C.5A–B is reserved for environmental presentation design and implementation. Phase 9 separately holds optional local schedule persistence and sensor-assisted scheduled watering; it does not change the current hosted read-only or local watering-authority architecture until separately designed and approved.
