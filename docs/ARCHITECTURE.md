...
- Phase 8C.5A is the approved environmental-presentation design in [`docs/product/phase8c5a-environmental-presentation-design.md`](./product/phase8c5a-environmental-presentation-design.md). Phase 8C.4 eligibility precedes Phase 8C.3 evidence health; only eligible evidence current under the existing inclusive 50-minute boundary may supply condition wording and measurement-specific card color. Last Good and Last Reliable evidence within that boundary retains condition/color while the pill independently reports evidence health; older evidence is neutral. Support diagnostics, future customer wording, trends/RMI, and firmware watering authority remain separate. Phase 8C.5B is the separately approved implementation slice. Phase 9 separately holds optional local schedule persistence and sensor-assisted scheduled watering.
