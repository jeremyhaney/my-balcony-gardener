...
- Phase 8C.5A Environmental Presentation Design is approved and documentation-complete. The matrix separates Phase 8C.4 eligibility, Phase 8C.3 evidence health, gardener condition, measurement-specific card color, Support diagnostics, future customer wording, and firmware authority. Last Good and Last Reliable values retain condition and color through the existing inclusive 50-minute boundary; older evidence is neutral and pill escalation remains unchanged. Phase 8C.5B is the next separately approved implementation slice. Authority: [`docs/product/phase8c5a-environmental-presentation-design.md`](./product/phase8c5a-environmental-presentation-design.md). After 8C.5B closeout, prioritization must explicitly compare Feels Like/Dew Point, customer adoption, deterministic Demo, Gen1 review, major UI modernization, and pressing site work including watering-event completeness and threshold presentation. Local schedule persistence and sensor-assisted watering are deferred to Phase 9.
