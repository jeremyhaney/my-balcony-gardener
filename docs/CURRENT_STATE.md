...
- Phase 8B `/measurements` slice is COMPLETE / END-TO-END VALIDATED; Phase 8B overall endpoint cleanup remains IN PROGRESS, with `/capabilities` next and `/status` still planned.
