...
- Phase 8B remains CURRENT and its overall endpoint cleanup remains IN PROGRESS. Phase 8B.2 `/measurements` is COMPLETE / END-TO-END VALIDATED, Phase 8B.3 `/capabilities` is COMPLETE / LIVE DEVICE VALIDATED, Phase 8B.4 `/status` is COMPLETE / LIVE DEVICE, CLOUD, AND HOSTED-DIAGNOSTICS VALIDATED, and Phase 8B.5 Gen2 Endpoint Integration and Closeout is CURRENT / NEXT.
...
- Phase 8B.4 changed no pins, installed-sensor assignments, GPIO modes/polarity, I2C/mux topology, thresholds, watering duration/cooldown/cadence, relay/button/interlock behavior, automatic SEN0308 authority, Supabase command/control, hosted Water Now, hosted IP/MAC exposure, or Gen1 endpoint contract. Phase 8B.5 Gen2 Endpoint Integration and Closeout is next.
