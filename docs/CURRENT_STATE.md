...
- Phase 8C.5A Environmental Presentation Design is documentation-complete, and Phase 8C.5B is implemented and locally validated. Current eligible cards show concise environmental meaning in the upper-right pill instead of redundant `Current`; evidence exceptions retain evidence wording. Measurement-specific full-card colors and footer scales cover light, air temperature, humidity, local pressure, reservoir, RMI, and soil temperature. Last Good/Last Reliable condition currency remains inclusive through 50 minutes, pill escalation remains unchanged, and no query or Disk I/O was added. Validation passed 36/36 tests, lint, build, diff checks, desktop/mobile review, and Jeremy's final local approval. Design: [`docs/product/phase8c5a-environmental-presentation-design.md`](./product/phase8c5a-environmental-presentation-design.md). Implementation: [`docs/product/phase8c5b-environmental-presentation-implementation.md`](./product/phase8c5b-environmental-presentation-implementation.md). Separate authenticated production validation after push is not claimed. Post-8C.5 prioritization remains unnumbered; Phase 9 schedule/sensor-assisted watering remains deferred.
