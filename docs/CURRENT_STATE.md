...
- Phase 8F.11 completes the tracked-repository retirement audit, preserves historical and recovery evidence, finds no remaining executable Gen1 path or current retired identity/configuration/schema dependency, and operationally closes Phase 8F. Phase 8G Watering-Threshold Presentation is next; no Phase 8G implementation is included. See the [closeout record](./product/phase8f11-final-gen1-retirement-audit-and-closeout.md).
