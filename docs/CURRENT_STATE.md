...
- The next numbered Phase 8 path is 8C.5A Environmental Presentation Design followed by separately approved 8C.5B implementation. After 8C.5B closeout, prioritization must explicitly compare Feels Like/Dew Point, customer adoption, deterministic Demo, Gen1 review, major UI modernization, and pressing site work including watering-event completeness and threshold presentation. Local schedule persistence and sensor-assisted watering are deferred to Phase 9 as a distinct secondary automation direction.
