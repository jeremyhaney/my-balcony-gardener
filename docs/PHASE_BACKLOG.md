...
| ✅ COMPLETE | Phase 8B | Balcony02 Gen2 Controller Deployment and Endpoint Contract Cleanup | Phase 8B.1 through Phase 8B.5 are complete at their recorded evidence levels; the final hosted frontend is production validated. |
...
| 🟡 PLANNED | Phase 8B.6 | Hosted Short History Window Expansion | Add 3-hour, 6-hour, and 12-hour hosted history windows while preserving 24 hours as default, existing longer windows, URL state behavior, expected-report calculations, current chart behavior, and hosted read-only boundaries. |
...
- Phase 8B.6 Hosted Short History Window Expansion is PLANNED: add 3-hour, 6-hour, and 12-hour hosted history windows while preserving 24 hours as the default, existing longer windows, URL state behavior, expected-report calculations, current chart behavior, and hosted read-only boundaries.
...
- Derived weather metrics remain future work. Dew point and heat index are not implemented and are not part of Phase 8B.5 or the planned Phase 8B.6 scope.
...
- Phase 8B parent status: COMPLETE. Phase 8B.1 through Phase 8B.4 retain their recorded completion evidence; Phase 8B.5 is COMPLETE / PRODUCTION VALIDATED in commits `a291be6` and `a8b282e`. Phase 8B.6 Hosted Short History Window Expansion is PLANNED.
