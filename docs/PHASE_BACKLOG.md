...
| 🟡 ACTIVE | Phase 8F | Gen1 Risk Review, Containment, and Retirement | Phase 8F.1–8F.5 retire obsolete local/frontend history consumers, selectable profiles, and unreachable firmware implementation; registry/database/history review remains separately bounded. |
...
- **Phase 8F — ACTIVE THROUGH 8F.5:** Phase 8F.1–8F.3 retire unsupported frontend/local/history paths; Phase 8F.4 retires obsolete firmware environments; Phase 8F.5 retires unreachable Gen1 firmware writers, endpoints, modules, branches, and defaults while preserving the sole supported Balcony02 Gen2 contract and safety boundary. Implementation records: [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./product/phase8f1-retire-unsupported-live-measurements-frontend.md), [`phase8f2-retire-livestats-local-water-now-frontend.md`](./product/phase8f2-retire-livestats-local-water-now-frontend.md), [`phase8f3-retire-local-dashboard-sensor-logs-frontend.md`](./product/phase8f3-retire-local-dashboard-sensor-logs-frontend.md), [`phase8f4-retire-obsolete-firmware-build-profiles.md`](./product/phase8f4-retire-obsolete-firmware-build-profiles.md), and [`phase8f5-retire-unreachable-gen1-firmware-implementation.md`](./product/phase8f5-retire-unreachable-gen1-firmware-implementation.md).
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is COMPLETE / HOSTED-VALIDATED in commit `8d90cec77ec128ee7eeaba304fc24cd5cb3a2453`; it was pushed, deployed, Jeremy-validated, and operationally closed with the recorded live-feature/no-byte-correspondence proof boundary. Phase 8F is ACTIVE through 8F.5, with frontend/history paths, obsolete firmware profiles, and unreachable Gen1 firmware implementation retired; registry/database/historical-reference review remains separate. Phase 8G threshold presentation, Phase 8H customer adoption/customer-led modernization, and Phase 8I deterministic Demo remain planned. Phase 9A/9B optional automation is DEFERRED.
