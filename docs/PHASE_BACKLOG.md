...
| **8F — Gen1 risk review, containment, and retirement** | Active through 8F.4 | Retired unsupported frontend paths and obsolete firmware profiles; Gen1 source-branch review remains | Bounded cleanup slices |
...
| 🟡 ACTIVE | Phase 8F | Gen1 Risk Review, Containment, and Retirement | Phase 8F.1 and 8F.2 retire both obsolete local frontend consumers; firmware and other compatibility review remains for later bounded slices. |
...
- **Phase 8F — ACTIVE:** Gen1 Risk Review, Containment, and Retirement. Phase 8F.1 retires the proven-obsolete Prototype01 frontend path, and Phase 8F.2 retires `LiveStats`, direct browser `/logs` polling, and local Water Now. Firmware and other compatibility inventory/retirement remain bounded follow-on work. Implementation records: [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./product/phase8f1-retire-unsupported-live-measurements-frontend.md) and [`phase8f2-retire-livestats-local-water-now-frontend.md`](./product/phase8f2-retire-livestats-local-water-now-frontend.md).
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is COMPLETE / HOSTED-VALIDATED in commit `8d90cec77ec128ee7eeaba304fc24cd5cb3a2453`; it was pushed, deployed, Jeremy-validated, and operationally closed with the recorded live-feature/no-byte-correspondence proof boundary. Phase 8F is ACTIVE: 8F.1 retires the unsupported Prototype01 frontend path and 8F.2 retires `LiveStats`, browser `/logs` polling, and local Water Now; firmware and other compatibility slices remain unapproved follow-on work. Phase 8G threshold presentation, Phase 8H customer adoption/customer-led modernization, and Phase 8I deterministic Demo remain planned. Phase 9A/9B optional automation is DEFERRED.
