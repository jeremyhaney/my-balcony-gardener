...
| **8E — Feels Like and Dew Point** | Implemented / local validated; pending deployment and hosted closeout | Add familiar derived microclimate values with honest paired-evidence rules | Yes—new display-only values |
...
| 🟠 VALIDATION | Phase 8E | Feels Like and Dew Point | Implemented and locally validated from existing exact package provenance; deployment, authenticated hosted validation, and closeout remain. |
...
- **Phase 8E — IMPLEMENTED / LOCAL VALIDATED:** Feels Like and Dew Point now share one exact package-provenance formula/evidence path for cards and chart series. No SQL or query change is required; deployment, authenticated hosted validation, and closeout remain; see [`phase8e-feels-like-and-dew-point-implementation.md`](./product/phase8e-feels-like-and-dew-point-implementation.md).
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is IMPLEMENTED / LOCAL VALIDATED from existing exact package provenance, pending deployment, authenticated hosted validation, and closeout; 8F Gen1 risk retirement, 8G threshold presentation, 8H customer adoption/customer-led modernization, and 8I deterministic Demo remain planned. Phase 9A/9B optional automation is DEFERRED.
