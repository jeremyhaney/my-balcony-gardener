...
| 🔵 CURRENT | Phase 8B | Balcony02 Gen2 Controller Deployment and Endpoint Contract Cleanup | Parent phase remains IN PROGRESS: physical buildout and all three endpoint slices are complete; integrated closeout is next. |
...
| 🔵 CURRENT / NEXT | Phase 8B.5 | Gen2 Endpoint Integration and Closeout | Validate `/measurements`, `/capabilities`, and `/status` together; close contract documentation and regression evidence. |
...
- Phase 8B.5 Gen2 Endpoint Integration and Closeout — CURRENT / NEXT.
- The Phase 8B parent remains CURRENT and the overall endpoint cleanup remains IN PROGRESS until integrated endpoint closeout is finished.
...
- Deferred status evidence: controlled disconnected state, nonzero lightweight reconnect counting, full recovery, and failed cloud posts. Deferred watering regression evidence: reservoir absence/loss, Wi-Fi loss, and cloud failure. Phase 8B.5 Gen2 Endpoint Integration and Closeout is the exact next slice.
...
- Phase 8B parent status: CURRENT / overall endpoint cleanup IN PROGRESS. Phase 8B.1 through Phase 8B.4 are COMPLETE; Phase 8B.4 is LIVE DEVICE, CLOUD, AND HOSTED-DIAGNOSTICS VALIDATED, and Phase 8B.5 Gen2 Endpoint Integration and Closeout is CURRENT / NEXT.
