...
| **8F — Gen1 risk review, containment, and retirement** | Active through 8F.5 | Retired unsupported frontend/history paths, obsolete firmware profiles, and unreachable Gen1 firmware implementation | Bounded cleanup slices |
...
| 🟡 ACTIVE | Phase 8F | Gen1 Risk Review, Containment, and Retirement | Phase 8F.1–8F.6 retire obsolete local/frontend history consumers, selectable profiles, unreachable firmware implementation, and legacy firmware URL-shape compatibility; Phase 8F.7 completes read-only retired-device inventory and verified safety export. Destructive database cleanup remains separately bounded and unapproved. |
...
- **Phase 8F — ACTIVE THROUGH 8F.7:** Phase 8F.1–8F.3 retire unsupported frontend/local/history paths; Phase 8F.4 retires obsolete firmware environments; Phase 8F.5 retires unreachable Gen1 firmware writers, endpoints, modules, branches, and defaults; Phase 8F.6 migrates the private firmware URL contract to the project root and removes legacy configured-table suffix compatibility; Phase 8F.7 inventories live retired-device rows/exposure and creates a verified protected safety export without mutation. The sole supported Balcony02 Gen2 contract and safety boundary remain preserved. Destructive cleanup still requires an explicit slice and approval. Records: [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./product/phase8f1-retire-unsupported-live-measurements-frontend.md), [`phase8f2-retire-livestats-local-water-now-frontend.md`](./product/phase8f2-retire-livestats-local-water-now-frontend.md), [`phase8f3-retire-local-dashboard-sensor-logs-frontend.md`](./product/phase8f3-retire-local-dashboard-sensor-logs-frontend.md), [`phase8f4-retire-obsolete-firmware-build-profiles.md`](./product/phase8f4-retire-obsolete-firmware-build-profiles.md), [`phase8f5-retire-unreachable-gen1-firmware-implementation.md`](./product/phase8f5-retire-unreachable-gen1-firmware-implementation.md), [`phase8f6-migrate-firmware-supabase-url-to-project-root.md`](./product/phase8f6-migrate-firmware-supabase-url-to-project-root.md), and [`phase8f7-retired-device-registry-inventory-and-safety-export.md`](./product/phase8f7-retired-device-registry-inventory-and-safety-export.md).
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is COMPLETE / HOSTED-VALIDATED in commit `8d90cec77ec128ee7eeaba304fc24cd5cb3a2453`; it was pushed, deployed, Jeremy-validated, and operationally closed with the recorded live-feature/no-byte-correspondence proof boundary. Phase 8F is ACTIVE through 8F.7, with frontend/history paths, obsolete firmware profiles, unreachable Gen1 firmware implementation, and legacy firmware URL-shape compatibility retired, plus live retired-device truth and a verified external safety export recorded. Registry-row deletion and local executable-registry cleanup remain separate, explicit future slices. Phase 8G threshold presentation, Phase 8H customer adoption/customer-led modernization, and Phase 8I deterministic Demo remain planned. Phase 9A/9B optional automation is DEFERRED.
