...
| **8E — Feels Like and Dew Point** | Next | Add familiar derived microclimate values with honest paired-evidence rules | Yes—new display-only values |
...
| ➡️ NEXT | Phase 8E | Feels Like and Dew Point | Small derived microclimate presentation slice with exact paired-evidence rules. |
...
- **Phase 8E — NEXT:** Feels Like and Dew Point. Small, familiar, display-only microclimate derivations with exact source eligibility and time-alignment rules.
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is NEXT, followed by 8F Gen1 risk retirement, 8G threshold presentation, 8H customer adoption/customer-led modernization, and 8I deterministic Demo. Phase 9A/9B optional automation is DEFERRED.
