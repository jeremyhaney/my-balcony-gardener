...
| **8F — Gen1 risk review, containment, and retirement** | Active through 8F.8 | Retired unsupported frontend/history paths, obsolete firmware profiles, unreachable Gen1 firmware implementation, and local frontend registry/configuration residue | Bounded cleanup slices |
...
| 🟡 ACTIVE | Phase 8F | Gen1 Risk Review, Containment, and Retirement | Phase 8F.1–8F.7 retire obsolete frontend/history/firmware surfaces and establish protected deletion evidence; Phase 8F.8 retires local frontend registry/configuration residue. Destructive database cleanup remains separately bounded and unapproved. |
...
- **Phase 8F — ACTIVE THROUGH 8F.8:** Phase 8F.1–8F.3 retire unsupported frontend/local/history paths; Phase 8F.4 retires obsolete firmware environments; Phase 8F.5 retires unreachable Gen1 firmware writers, endpoints, modules, branches, and defaults; Phase 8F.6 migrates the private firmware URL contract to the project root; Phase 8F.7 inventories live retired-device rows/exposure and creates a verified protected safety export without mutation; Phase 8F.8 retires local frontend registry identities and browser-to-device configuration while preserving the Balcony02 Demo and authorization-derived Customer/Support routes. Destructive cleanup still requires refreshed proof and explicit approval. Records: [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./product/phase8f1-retire-unsupported-live-measurements-frontend.md), [`phase8f2-retire-livestats-local-water-now-frontend.md`](./product/phase8f2-retire-livestats-local-water-now-frontend.md), [`phase8f3-retire-local-dashboard-sensor-logs-frontend.md`](./product/phase8f3-retire-local-dashboard-sensor-logs-frontend.md), [`phase8f4-retire-obsolete-firmware-build-profiles.md`](./product/phase8f4-retire-obsolete-firmware-build-profiles.md), [`phase8f5-retire-unreachable-gen1-firmware-implementation.md`](./product/phase8f5-retire-unreachable-gen1-firmware-implementation.md), [`phase8f6-migrate-firmware-supabase-url-to-project-root.md`](./product/phase8f6-migrate-firmware-supabase-url-to-project-root.md), [`phase8f7-retired-device-registry-inventory-and-safety-export.md`](./product/phase8f7-retired-device-registry-inventory-and-safety-export.md), and [`phase8f8-retire-local-device-registry-and-frontend-configuration.md`](./product/phase8f8-retire-local-device-registry-and-frontend-configuration.md).
...
- Phase 8C.1–8C.5B status: COMPLETE at their recorded evidence levels; 8C.5B is committed, pushed, and hosted-validated. Phase 8D watering-event restoration is COMPLETE / HOSTED-VALIDATED in commit `406bce9`. Phase 8E Feels Like/Dew Point is COMPLETE / HOSTED-VALIDATED in commit `8d90cec77ec128ee7eeaba304fc24cd5cb3a2453`; it was pushed, deployed, Jeremy-validated, and operationally closed with the recorded live-feature/no-byte-correspondence proof boundary. Phase 8F.10 is COMPLETE at the recorded database evidence level: frontend/history paths, obsolete firmware profiles, unreachable Gen1 firmware implementation, legacy firmware URL-shape compatibility, local frontend registry/configuration residue, 81,575 retired-device rows, the final six development-validation rows, and the obsolete `sensor_logs` schema/access surface are retired. Retained `sensor_events` has no Data API role grants. Balcony02 and all protected evidence remain. Phase 8G threshold presentation, Phase 8H customer adoption/customer-led modernization, and Phase 8I deterministic Demo remain planned. Phase 9A/9B optional automation is DEFERRED.
