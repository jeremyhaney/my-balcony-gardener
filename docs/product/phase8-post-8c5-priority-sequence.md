...
Status: Approved roadmap sequence; Phases 8D and 8E are complete, hosted-validated, and operationally closed. Phase 8F is active through the approved bounded 8F.1–8F.6 frontend, history, firmware-profile, unreachable-source, and firmware-configuration compatibility retirement slices. Other slices still require their own discovery, boundary approval, implementation approval, validation, and closeout.
...
- **Phase 8F is active through Phase 8F.6.** Phase 8F.1–8F.3 retire unsupported local/frontend history consumers. Phase 8F.4 retires obsolete Balcony01, Scout01, and Prototype01/Bench01 PlatformIO environments and default selection. Phase 8F.5 retires unreachable Gen1 firmware posting/endpoints, DHT/direct-soil/VEML and runtime-scan modules, excluded status/heartbeat/setup/loop sides, and implicit profile defaults. Phase 8F.6 migrates the ignored firmware Supabase URL to the same project's HTTPS root, rejects unsafe and legacy URL shapes before builds, and removes configured-table suffix rewriting while preserving exact active Gen2 table routes. The sole supported `balcony02-gen2` static endpoint contract, physical-button/reservoir safety, pump shutoff, and local control authority remain unchanged. Supabase schema/data/policies, hosted behavior, frontend configuration, and registry entries remain. See [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./phase8f1-retire-unsupported-live-measurements-frontend.md), [`phase8f2-retire-livestats-local-water-now-frontend.md`](./phase8f2-retire-livestats-local-water-now-frontend.md), [`phase8f3-retire-local-dashboard-sensor-logs-frontend.md`](./phase8f3-retire-local-dashboard-sensor-logs-frontend.md), [`phase8f4-retire-obsolete-firmware-build-profiles.md`](./phase8f4-retire-obsolete-firmware-build-profiles.md), [`phase8f5-retire-unreachable-gen1-firmware-implementation.md`](./phase8f5-retire-unreachable-gen1-firmware-implementation.md), and [`phase8f6-migrate-firmware-supabase-url-to-project-root.md`](./phase8f6-migrate-firmware-supabase-url-to-project-root.md).
