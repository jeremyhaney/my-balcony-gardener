...
Status: Approved roadmap sequence; Phases 8D and 8E are complete, hosted-validated, and operationally closed. Phase 8F is active through the approved bounded 8F.1–8F.5 frontend, history, firmware-profile, and unreachable-source retirement slices. Other slices still require their own discovery, boundary approval, implementation approval, validation, and closeout.
...
- **Phase 8F is active through Phase 8F.5.** Phase 8F.1–8F.3 retire unsupported local/frontend history consumers. Phase 8F.4 retires obsolete Balcony01, Scout01, and Prototype01/Bench01 PlatformIO environments and default selection. Phase 8F.5 retires unreachable Gen1 firmware posting/endpoints, DHT/direct-soil/VEML and runtime-scan modules, excluded status/heartbeat/setup/loop sides, and implicit profile defaults while preserving the sole supported `balcony02-gen2` static endpoint contract, active Gen2 Data API writes, physical-button/reservoir safety, pump shutoff, and local control authority. Supabase schema/data/policies, hosted behavior, and registry entries remain. See [`phase8f1-retire-unsupported-live-measurements-frontend.md`](./phase8f1-retire-unsupported-live-measurements-frontend.md), [`phase8f2-retire-livestats-local-water-now-frontend.md`](./phase8f2-retire-livestats-local-water-now-frontend.md), [`phase8f3-retire-local-dashboard-sensor-logs-frontend.md`](./phase8f3-retire-local-dashboard-sensor-logs-frontend.md), [`phase8f4-retire-obsolete-firmware-build-profiles.md`](./phase8f4-retire-obsolete-firmware-build-profiles.md), and [`phase8f5-retire-unreachable-gen1-firmware-implementation.md`](./phase8f5-retire-unreachable-gen1-firmware-implementation.md).
